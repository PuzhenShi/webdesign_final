...
function ProfileHead() {
  ...
  useEffect(() => {
   ...
   // console.log(loginType);
    ...
    return (
        <div class="col-8 ml-8 mb-8 rounded" id="profileHeadOut">
            <p>Upload your profile photo:</p>
            
            <div class="col-5">
                <div id="upload-box">
                    <input type="file" accept=".jpeg, .jpg, .png" onChange={handleUpload} />
            ...
            <Button variant="primary" id="profileHeadBtn" onClick={upLoad}>
                save
            </Button>
